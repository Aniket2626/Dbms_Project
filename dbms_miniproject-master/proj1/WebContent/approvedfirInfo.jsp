...
<div id="contain">
	 <i class="fa fa-lessthan"></i><a href="approvedFir.jsp"><i class="fa fa-arrow-left" aria-hidden="true" onclick=""></i></a>
</div>
<%
...
System.out.println("table="+table);
	...
	String sql="select * from approvedFir where fir_id=?;";
...
<tr>
	<th>VEHICLE_BILL</th>
	<td><a href="image.jsp?src=./stolen/<%=rs1.getString(8)%>" target="_blank">Click here to see bill</a></td>
</tr>
<tr>
	<th>VEHICLE_PHOTO</th>
...
<div class="approve"><center>Approved</center></div>
